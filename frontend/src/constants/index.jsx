export const features = [
  {
    ...
    title: "Dynamic Price for Airlines",
    text: "with SurgeNova AI's seamless integration, you can effortlessly connect to your existing systems and workflows, making the transition to AI-powered pricing optimization a breeze.",
    button: {
  ...
  },
  {
    ...
    title: "Dynamic Price for Railways",
    text: " SurgeNova AI prioritizes the security and privacy of your data, ensuring that your sensitive information is protected while delivering powerful insights to optimize your pricing strategies.",
    button: {
...
export const details = [
  {
    ...
    title: "Hotels best price",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Cabs fair price ",
  },
  {
    id: "2",
...
export const faq = [
  // generatte 10 quesrtions and answers related to surge nova ai
  {
    id: "0",
    question: "What is SurgeNova AI?",
    answer: "SurgeNova AI is an advanced pricing optimization platform designed to help airlines and railways maximize revenue by leveraging artificial intelligence to analyze market trends, competitor pricing, and customer behavior.",
  },
  {
    id: "1",
    question: "How does SurgeNova AI work?",
    answer: "SurgeNova AI uses machine learning algorithms to analyze vast amounts of data, including historical pricing, booking patterns, and market conditions. It then generates dynamic pricing recommendations that help businesses optimize their revenue while remaining competitive.",
  },
  {
    id: "2",
    question: "Is SurgeNova AI suitable for small airlines and railways?",
    answer: "Yes, SurgeNova AI is designed to be scalable and can benefit businesses of all sizes. Whether you're a small regional airline or a large national railway, our platform can help you optimize your pricing strategies effectively.",
  },
  {
    id: "3",
    question: "How secure is my data with SurgeNova AI?",
    answer: "SurgeNova AI prioritizes data security and privacy. We implement robust security measures to protect your sensitive information, ensuring that your data is safe while providing powerful insights for pricing optimization.",
  },
  {
    id: "4",
    question: "Can SurgeNova AI integrate with my existing systems?",
    answer: "Yes, SurgeNova AI is designed for seamless integration with your existing systems and workflows. Our platform can easily connect to your current infrastructure, allowing for a smooth transition to AI-powered pricing optimization.",
  },
  {
    id: "5",
    question: "What kind of support does SurgeNova AI offer?",
    answer: "SurgeNova AI offers 24/7 customer support to assist you with any questions or issues you may encounter. Our dedicated support team is always ready to help you get the most out of our platform.",
  },
  {
    id: "6",
    question: "How can I get started with SurgeNova AI?",
    answer: "Getting started with SurgeNova AI is easy! Simply contact our sales team to schedule a demo and discuss your specific needs. We'll work with you to implement our platform and start optimizing your pricing strategies.",
  },
  {
    id: "7",
    question: "Does SurgeNova AI offer a free trial?",
    answer: "Yes, we offer a free trial of SurgeNova AI so you can experience the benefits of our platform firsthand. Contact our sales team to learn more about how to access the trial.",
  },
...
export const testimonials = [
  {
    ...
    comment:
      "SurgeNova AI has revolutionized my workflow! It’s like having an AI assistant that never sleeps.",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment:
      "Initially skeptical, but now I rely on SurgeNova AI for debugging and code suggestions daily. Incredible tool!",
  },
  {
    id: "2",
    name: "Ananya Singh",
    role: "Tech Innovators India",
    avatarUrl: "/images/testimonials/ananya-singh.png",
    comment:
      "Using SurgeNova AI for my React projects has saved me countless hours. Truly a game-changer for developers in India!",
  },
  {
    id: "3",
    name: "Rohit Mehta",
    role: "Data Wizards Pvt Ltd",
    avatarUrl: "/images/testimonials/rohit-mehta.png",
    comment:
      "The AI suggestions are so accurate and context-aware. SurgeNova AI feels like a co-developer in my team.",
  },
  {
    id: "4",
    name: "Priya Sharma",
    role: "CyberLeap",
    avatarUrl: "/images/testimonials/priya-sharma.png",
    comment:
      "SurgeNova AI makes complex coding tasks effortless. I can focus on creativity while the AI handles the repetitive parts.",
  },
  {
    id: "5",
    name: "Jim Bradley",
    ...
    comment:
      "The efficiency boost is undeniable. SurgeNova AI has transformed our workflow, forever.",
  },
];
